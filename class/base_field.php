 ...
 */
    ...
    //  Абстрактный метод, для возврата инини названия поля с самого тэга элемента управления
    ...
    //  Функция перевода текста с русского в транслит (латиницу)
    protected function encodestring($str)
    {
        ...
        // Возвращаем результат преобразования в латиницу
        return $str;
    }
